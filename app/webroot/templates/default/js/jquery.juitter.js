...
(function($) {
	...
	$.Juitter = {
					...
					$.each(json.results,function(i,item) {
						if(e==1 || (i<numMSG && item.id>ultID)){
							...
							if (item.text != "undefined") {
								...
								else mHTML="<span class=\"data\">"+item.created_at+"</span><h3> <a class=\"tweet\" href='" + link + "' "+openLink+">"+$.Juitter.textFormat(tweet)+" asa</a></h3><br class=\"clear\">";
		...
		//make links
			...
			texto = texto.replace(exp,"<a href='$1' id=\"dd\" class='extLink' "+openLink+">$1</a>"); 
